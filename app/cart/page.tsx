...
const Cart = () => {
    const [products, setProducts] = useState<ProductType[]>(JSON.parse(localStorage.getItem("carts") || "[]"));
        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="mt-3 text-lg text-gray-500">{products.length} item{products.length !== 1 ? 's' : ''} in your cart</p>
                </div>
                                            ...
                                            <div>
                                                <div className="flex justify-between items-start">
                                                    <div>
                                                        ...
                                                        <h3 className="mt-2 text-lg font-medium text-gray-900 line-clamp-2">{product.title}</h3>
                                                    </div>
                                                    <button 
                        ...
                        <div className="bg-white shadow-sm rounded-lg p-6 sticky top-4">
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">{calculateSubtotal().toLocaleString("en-US", { style: 'currency', currency: 'USD' })}</span>
                                </div>
                                
                                <div className="flex justify-between">
                                    <span className="text-gray-600">Shipping</span>
                                    <span className="font-medium">{shipping.toLocaleString("en-US", { style: 'currency', currency: 'USD' })}</span>
                                </div>
                                ...
                                <div className="text-sm text-gray-500 mt-1">Including VAT</div>
                            </div>
                            ...
                            <div className="mt-6 text-center">
                                <Link href="/products" className="text-indigo-600 hover:text-indigo-500 text-sm font-medium">
                                    Continue Shopping
                                </Link>
                            </div>
                        </div>
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50  px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8 text-center">
                <div className="bg-white p-8 rounded-lg shadow-sm">
                    ...
                    <div className="mt-6">
                        <Link href="/products" className="w-full flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Browse Products
                        </Link>
                    </div>
                </div>
